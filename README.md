...
> 이 프로젝트는 앞으로 **사용자가 원하는 특정 장르에 속한 영화들의 평균 평점을 조회해 인기 영화를 선별하는 기능으로 확장**할 수 있습니다.  
> 이를 위해 **장르 컬럼을 활용**한 추가적인 파티셔닝이나 복합 인덱스 설계로 성능 향상을 기대할 수 있으며,  
> 실제 서비스 환경에서 더욱 다양한 조건을 반영한 고성능 데이터 조회가 가능하도록 발전시킬 수 있을 것입니다.
